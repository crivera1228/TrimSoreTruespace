  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        <section
          className={`relative w-full py-12 md:py-24 lg:py-32 xl:py-48 bg-cover bg-center transition-opacity duration-1000 ease-in-out ${isLoaded ? "opacity-100" : "opacity-0"}`}
          ...
          <div className="container relative z-10 px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              <p className="max-w-[700px] text-white md:text-xl">
                Professional car detailing services to keep your vehicle looking
                its best.
              </p>
